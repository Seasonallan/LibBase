...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context) {
        ...
        float minVel = MIN_FLING_VELOCITY * getResources().getDisplayMetrics().density;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (ret) {
                ...
                if (mListener != null) {
                    mListener.onEdgeTouch(mTrackingEdge);
                }
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mListener != null) {
                mListener.onScrollStateChange(mDragHelper.getViewDragState(), mScrollPercent);
            }
            ...
            if (mListener != null
                ...
                mListener.onScrollOverThreshold();
            }

            if (mScrollPercent >= 1) {
                if (null != mListener) {
                    mListener.onContentViewSwipedBack();
                }
            }
        }
        ...
        public void onViewDragStateChanged(int state) {
            ...
            if (mListener != null) {
                mListener.onScrollStateChange(state, mScrollPercent);
            }
        }
    }
}
