package com.library.base.widget.bar.navigation;
...
public class BottomNavigationBar extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mBackgroundResource = typedArray.getResourceId(R.styleable.BottomNavigationBar_bnbBackgroundRes, R.mipmap.background_bottom_tab);
            ...
            mBackgroundResource = R.mipmap.background_bottom_tab;
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
                ...
                mContainer.setBackgroundResource(mBackgroundResource);
            }
