package com.library.base.widget.bar.title;
...
import com.library.base.widget.bar.title.style.TitleBarLightStyle;
import com.library.base.widget.bar.title.style.TitleBarNightStyle;
import com.library.base.widget.bar.title.style.TitleBarTransparentStyle;
...
public class TitleBar extends FrameLayout
    ...
    private void initStyle(AttributeSet attrs) {
        ...
        // 文字大小设置
        setLeftSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.TitleBar_leftSize, (int) style.getLeftSize()));
        setTitleSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.TitleBar_titleSize, (int) style.getTitleSize()));
        setRightSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.TitleBar_rightSize, (int) style.getRightSize()));
    ...
    public void setLeftIcon(Drawable drawable) {
        mLeftView.setCompoundDrawablePadding((int) (15 * getResources().getDisplayMetrics().density));
