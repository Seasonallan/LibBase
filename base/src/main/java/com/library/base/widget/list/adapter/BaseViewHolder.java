...
import com.library.base.widget.list.SwipeItemView;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public void enableSwipe(boolean canSwipe){
        if (itemView instanceof SwipeItemView){
            ((SwipeItemView) itemView).setCanSwipe(canSwipe);
        }
    }

    public boolean isSwipeOpened(){
        return SwipeItemView.activeItemView == itemView;
    }
    ...
    public BaseViewHolder setTextColor(Context context, int viewId, int textColor) {
        TextView view = getView(viewId);
        view.setTextColor(ContextCompat.getColor(context, textColor));
        return this;
    }

    public BaseViewHolder setTextColor2(Context context, int viewId, int textColor) {
        TextView view = getView(viewId);
