package com.library.base.gif.movie;
...
/**
 * Disc: 解码器GifDecoder提取的获取GIF的第一帧
 * @see GifDecoder
...
public class FrameDecoder {
    ...
    public FrameDecoder(String strFileName){
        try {
    ...
    public FrameDecoder(Context context, int id){
        try {
    ...
    public Bitmap getFrame() {
        ...
        private void setPixels() {
            try {
                ...
                image = Bitmap.createBitmap(dest, width, height, Bitmap.Config.ARGB_8888);  // Config.RGB_565
